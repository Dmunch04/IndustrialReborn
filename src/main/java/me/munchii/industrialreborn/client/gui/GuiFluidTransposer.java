...
public class GuiFluidTransposer extends GuiBase<BuiltScreenHandler> {
    private final FluidTransposerBlockEntity blockEntity;

    public GuiFluidTransposer(int syncID, final PlayerEntity player, final FluidTransposerBlockEntity blockEntity) {
