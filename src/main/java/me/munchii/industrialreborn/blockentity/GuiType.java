...
public class GuiType<T extends BlockEntity> implements IMachineGuiHandler {
    ...
    public static final GuiType<FluidInfuserBlockEntity> FLUID_INFUSER = register("fluid_infuser");
    ...
    public static final GuiType<AutoEnchanterBlockEntity> AUTO_ENCHANTER = register("auto_enchanter");
